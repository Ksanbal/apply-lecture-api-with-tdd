...
import { lecturesService } from '../../service/lectures-service.provider';
import { LecturesApplicationRepository } from '../../../repository/lectures.repository.impl';
...
describe('LecturesController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [lecturesService, LecturesApplicationRepository],
    }).compile();
